...
updateUser({ email: "john@test.com" }); // ✅ Valid
```
...
<QuizBuilder title="Advanced Types Quiz" description="Utility types refresher">
  <QuizQuestion
...
<QuizBuilder title="Advanced Types Quiz">
  <QuizQuestion
    id="ts-utility-pick"
...
You're well on your way to TypeScript mastery! 🎯
