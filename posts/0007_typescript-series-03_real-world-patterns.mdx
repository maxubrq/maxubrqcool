...
<QuizBuilder title="Patterns Quiz" description="Null handling best practices">
  <QuizQuestion
    id="ts-null-handling-best-way"
    ...
    correctAnswer="Use optional chaining and nullish coalescing"
  />
</QuizBuilder>

<QuizBuilder title="Patterns Quiz">
  <QuizQuestion
    id="ts-async-multiple-states-pattern"
    ...
    correctAnswer="Using discriminated unions"
  />
</QuizBuilder>
